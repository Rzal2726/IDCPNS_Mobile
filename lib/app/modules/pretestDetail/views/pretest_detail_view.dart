              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Informasi Pretest", style: AppStyle.style17Bold),
                      SizedBox(height: 20),
                      Text(controller.judul.value, style: AppStyle.style17Bold),
                      SizedBox(height: 10),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Jumlah Soal", style: TextStyle(fontSize: 15)),
                          Text(
                            "${controller.jumlahSoal.value} Soal",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(height: 40),
                          Text(
                            "${controller.waktuMenit.value} Menit",
                            style: AppStyle.style15Bold,
                          ),
                        ],
                      ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      color:
                                          isFirst ? Colors.red : Colors.black,
                                      fontSize: 15,
                                    ),
                                  ),
                                ),
